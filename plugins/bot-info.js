let handler  = async (m, { conn }) => {
  ...
  conn.sendFile(m.chat, pp, 'profile.jpg',`*BOT HL GANS*\n\n\nBot ini dibuat menggunakan *NodeJS* dengan bantuan *Baileys* sebagai Whatsapp Web API dan dimodifikasi dari *Wabot-aq (Nurutomo)* dengan penuh cinta oleh Abang Ganteng *Hairul Lana* sehingga membuat botnya semakin tampan\n\nSilahkan ketik _.menu_ untuk melihat menu bot dan jangan lupa di baca ya, biar ga tolol !`, m)
}
